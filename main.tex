...
\def\workshoptitle{Linux-Workshop}
\def\shortworkshoptitle{Linux}
\subtitle{Einsteiger-Workshop}
\def\gruesswoerte{Gude!}
\author{Ruben Deisenroth}
\titlegraphic*{\includegraphics{Linux Mountains Wallpaper.png}}
...
\begin{document}
    ...
    \input{chapters/linux-vs-other-oses}
    \input{chapters/package-management}
\end{document}
